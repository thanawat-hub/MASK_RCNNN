...
def load_image_gt(dataset, config, image_id, augment=False, augmentation= imgaug.augmenters.Fliplr(0.5),
                  use_mini_mask=False):
...
#$
def data_generator(dataset, config, shuffle=True, augment=False, augmentation= imgaug.augmenters.Fliplr(0.5),
