...
from imgaug import augmenters as iaa #$aug
...
def load_image_gt(dataset, config, image_id, augmentation, augment=False ,
       use_mini_mask=False):
...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        #ถ้าใน inference mode มันกเสร้างโฟเดอป่าวๆให้เลย ln 2331
        #https://github.com/matterport/Mask_RCNN/pull/823
...
class MeanAveragePrecisionCallback(Callback):
    def __init__(self, train_model= MaskRCNN, inference_model= MaskRCNN, dataset= Dataset, #
                 calculate_map_at_every_X_epoch=5, dataset_limit=50,
                 verbose=1):
        super().__init__()
